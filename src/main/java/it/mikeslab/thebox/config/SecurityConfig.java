    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/static/**", "/manifest.json", "/static/js/service-worker.js", "/favicon.ico", "/js/**", "/videos/**", "/images/**", "/components/**", "/css/**").permitAll() // Permit all access to static resources
